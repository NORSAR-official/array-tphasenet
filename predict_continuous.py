...
Basic continuous prediction:
    python predict_continuous.py -c config.yaml

With custom config:
    python predict_continuous.py -c /path/to/custom_config.yaml
...
See Also
--------
evaluate_continuous.py : Evaluate continuous predictions
continuous_prediction_utils.py : Contains beam_phase_detection and related functions
...
parser = argparse.ArgumentParser(
    ...
    epilog='Example: python predict_continuous.py -c config.yaml'
)
parser.add_argument(
    '-c', '--config_file_name',
    default='config.yaml',
